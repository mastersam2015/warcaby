...
function check(a,b){
	...
	if ($("#k"+a+"a"+b).val()=="b"){
$("#"+a+"a"+b).html("");
kurs("<img src='bialy.png' width='50'>");
px=a;
py=b;
//alert("a="+a+" b="+b);
	}
...
$pupu="ca".$value{0}."a".$value{2}."apz";
$wuwu="";
$huhu=str_replace($pupu,$wuwu, $huhu);
//-damka
$pupu="ca".$value{0}."a".$value{2}."adz";
$wuwu="";
$huhu=str_replace($pupu,$wuwu, $huhu);
}
//po petli----------------
...
fputs($plik2, $huhu);
fclose($plik2);
header("Location: index.php?load=2");
	}
